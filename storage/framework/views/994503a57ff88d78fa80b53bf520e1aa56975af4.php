...
<div style="position:absolute;left:252.10px;top:347.14px" class="cls_003"><span class="cls_003">: <?php echo e($nama_donatur); ?></span></div>
<div style="position:absolute;left:142.85px;top:374.04px" class="cls_003"><span class="cls_003">Alamat</span></div>
<div style="position:absolute;left:252.10px;top:374.04px" class="cls_003"><span class="cls_003">: <?php echo e($alamat); ?></span></div>
<div style="position:absolute;left:142.85px;top:401.16px" class="cls_003"><span class="cls_003">Tanggal</span></div>
<div style="position:absolute;left:252.10px;top:401.16px" class="cls_003"><span class="cls_003">: <?php echo e(implode('-',array_reverse(explode('-', $tanggal)))); ?></span></div>
<div style="position:absolute;left:142.85px;top:428.04px" class="cls_003"><span class="cls_003">No Telpon</span></div>
<div style="position:absolute;left:252.10px;top:428.04px" class="cls_003"><span class="cls_003">: <?php echo e($no_telepon); ?></span></div>
<div style="position:absolute;left:142.85px;top:455.18px" class="cls_003"><span class="cls_003">Jenis Donasi</span></div>
<div style="position:absolute;left:252.10px;top:455.18px" class="cls_003"><span class="cls_003">: <?php echo e($jenis_donasi); ?></span></div>
<div style="position:absolute;left:142.85px;top:482.06px" class="cls_003"><span class="cls_003">Jumlah/Pack</span></div>
<div style="position:absolute;left:252.10px;top:482.06px" class="cls_003"><span class="cls_003">: <?php echo e($jumlah_donasi); ?></span></div>
...
<div style="position:absolute;left:108.05px;top:643.87px" class="cls_003"><span class="cls_003"><?php echo e($nama_donatur); ?></span></div>
<div style="position:absolute;left:396.14px;top:643.87px" class="cls_003"><span class="cls_003"><?php echo e($nama_penerima); ?></span></div>
</div>
