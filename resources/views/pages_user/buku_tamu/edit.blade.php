                        ...
                        <div class="card-body border-0">
                            <form method="POST" action="{{ route('tamu.update', $buku_tamu->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ $buku_tamu->nama }}" placeholder="Nama Lengkap" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="alamat" type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ $buku_tamu->alamat }}" placeholder="Alamat" autofocus>
